...
export class BlockListTests {
  ...
  add_address_with_type_adds_to_list(): void {
    const blockList = new BlockList();
  ...
  check_not_blocked_returns_false(): void {
    const blockList = new BlockList();
    blockList.addAddress("192.168.1.1");
  ...
  get_rules_returns_all_rules(): void {
    const blockList = new BlockList();
    blockList.addAddress("192.168.1.1");
