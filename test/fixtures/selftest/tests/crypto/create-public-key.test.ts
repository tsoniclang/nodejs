...
export class CreatePublicKeyTests {
  ...
  createPublicKey_from_private_key_works(): void {
    const { privateKey } = generateKeyPairSync("rsa");
  ...
  createPublicKey_from_public_key_returns_same(): void {
